...
<div class="content">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">Brokers List</h4>
                <ol class="breadcrumb">
            ...
            <div class="col-sm-12">
                <div class="card-box table-responsive">
                    <div class="btn-toolbar">
                        <div class="col-sm-11">
                            <h4 class="m-t-0 header-title"><b>Brokers List</b></h4>
                        </div>
                        <div class="col-sm-1">
 ...
 $(document).ready(function () {
    ...
    $(document.body).on('click', '.approved', function(e) {
       ...
       $.ajax({
           ...
           success: function(data) {
               toastr.success(data.message);
               $('.is_approved_'+broker_id).html('<span class="label label-success">Approved</span>');
           }
       });
   });
   $(document.body).on('click', '.reject', function(e) {
       ...
       $.ajax({
           ...
           success: function(data) {
               toastr.success(data.message);
               $('.is_approved_'+broker_id).html('<span class="label label-danger">Rejected</span>');
           }
       });
   });
    ...
    //             if(data.data == 0 )
    //             {
    //                 $('#approved_'+broker_id).attr("id","approve_"+broker_id).removeClass("label-success").addClass("label-danger").html ("Approve");
    //             }
    //             else
    //             {
    //                 $('#approve_'+broker_id).attr("id","approved_"+broker_id).removeClass("label-danger").addClass("label-success").html( "Approved");
    //             }
    //         }
    //     });
    // });
