...
<div class="content">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">Transmit Condition List</h4>
                <ol class="breadcrumb">
                    <!-- <li><a href="#">Ubold</a></li> -->
                    <li><a href="#">Home</a></li>
                    <li class="active">Transmit Condition List</li>
                </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box table-responsive">
                    <div class="btn-toolbar">
                        <div class="col-sm-11">
                            <h4 class="m-t-0 header-title"><b>Transmit Condition List</b></h4>
                        </div>
                        <div class="col-sm-1">
                            <a href="{{url('transmit_condition/add')}}" class="btn btn-default m-l-5">Add</a>
                        </div>
                    </div>
...
$(document).ready(function () {
    ...
    const table = $('#datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ url('transmit_condition/list') }}",
            type: 'POST',
        },
        columns: [
