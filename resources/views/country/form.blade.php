            ...
            <div class="col-sm-12">
                <div class="card-box">
                    <div class="btn-toolbar">
                        <div class="col-sm-11">
                            <h4 class="m-t-0 m-b-30 header-title"><b>Create Country</b></h4>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form class="form-horizontal group-border-dashed" action="javascript:void(0);" id="country_form">
                                @csrf
                                <input type="hidden" name="country_id" value="{{!empty($country) ? $country->id : ''}}">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Country Name</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="name" id="name" value="{{!empty($country) ? $country->name : ''}}" required placeholder="Enter Country Name" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-9 m-t-15">
                                        ...
                                        <a href="{{url('/country')}}" class="btn btn-default m-l-5">
                                            Cancel
                                        </a>
                                    </div>
                                </div>
